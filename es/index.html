...
-->
        ...
        <header class="main_menu_area">
            <nav class="navbar navbar-expand-lg navbar-light bg-light" id="mainNav">
                <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="../img/logo_peque.png" alt="" style="width: 250px; height: 50px"></a> 
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto text-center">
                        <li class="nav-item "><a class="nav-link js-scroll-trigger" href="#about">¿Quiénes somos?</a></li>
                        <li class="nav-itemv "><a class="nav-link js-scroll-trigger" href="#servicios">Servicios</a></li>
                    ...
                    <li data-index="rs-2946" data-transition="slidevertical" data-slotamount="1" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <div class="slider_text_box">
                            ...
                            <div class="tp-caption tp-resizeme secand_text"
                                 ...
                                 style="z-index: 8;font-family:'Poppins', sans-serif;font-weight:700;color:aqua;">RECLUTAMIENTO <br> SELECCIÓN <br> CAPACITACIÓN
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme slider_button"
                                 ...
                                 data-frames="[{&quot;delay&quot;:10,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;&quot;,&quot;mask&quot;:&quot;x:0px;y:[100%];s:inherit;e:inherit;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;y:[175%];&quot;,&quot;mask&quot;:&quot;x:inherit;y:inherit;s:inherit;e:inherit;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;}]"
                                 data-textAlign="['center','center','center','center','center','center']">
                                <a class="bg_btn js-scroll-trigger" href="#servicios">Nuestros servicios</a>
                                <a class="tp_btn js-scroll-trigger" href="#contacto">Contáctanos </a>
                            </div>
                        </div>
                    </li>
            ...
            <div class="container">
                <div class="c_feature_box">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="c_box_item">
                                <a ><h4><i class="fa fa-star" aria-hidden="true"></i> Valores </h4></a>
                                <p> •	Transparencia <br>•	Honestidad, <br>•	Compañerismo <br>•	Lealtad.</p>
                ...
                <div id="about" class="digital_featue p_100">
                    <div class="row">
                        <div class="col-lg-6">
...
<h4><a href="#">Aigars Silkalns</a> - CEO DeerCreative</h4>
        ...
        <!--================Project Area =================-->
        <section id="contacto" class="project_area mb-5" >
            <div class="container" >
                <div class="row">
                    <div class="col-lg-12 ">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2 class="section-heading  mb-5" style="font-size: 40px; font-family: Poppins, sans-serif; font-weight: 500; color: white;">Contáctanos </h2>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <h4 class="text-uppercase m-2">Address</h4>
                                <hr class="my-4">
                                <a href="https://www.google.com.mx/maps/place/Calle+Mina,+Cerro+de+la+Cruz,+Chihuahua,+Chih./@28.6066302,-106.0921691,16.33z/data=!4m5!3m4!1s0x86ce84520d077b87:0xda19b9213ed0840a!8m2!3d28.6069567!4d-106.0894974" class=" text-black-50">C. Mina 1000 Col. Centro Chihuahua, Chih. </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        ...
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="modal-body">
                                    ...
                                    <h2 class="text-uppercase">Presentación</h2>
                                    <!-- <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p> -->
                                    <img class="img-fluid d-block mx-auto" src="../img/feature-right.jpg" alt="">
                                    <p class=" text-left">Nos ponemos a su disposición para ayudar en su proceso de selección, ocupándonos de la parte en la que usted invertirá mucho tiempo y esfuerzo lo cual genera más costo, nosotros con gusto trabajamos en esto hasta dejar en sus manos el candidato para su selección. <br> <br> Ofrecemos un esquema de cotización competitivo, además de contar con sistema de garantía por cada persona seleccionada por su organización para desempeñar el puesto vacante.
                                    </p>
                                    <button class="d_feature_text submit_btn" data-dismiss="modal" type="button">
